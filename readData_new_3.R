topRaw = read.csv("./datas/3_1_data/top/13.csv");topRaw = sampleByData(topRaw); topRaw = topRaw[100:900,]
leftHandRaw = read.csv("./datas/3_1_data/lefthand/13.csv");leftHandRaw = sampleByData(leftHandRaw);  leftHandRaw = leftHandRaw[105:905,]
rightHandRaw = read.csv("./datas/3_1_data/righthand/13.csv");rightHandRaw = sampleByData(rightHandRaw);  rightHandRaw = rightHandRaw[99:899,]
leftPantsRaw = read.csv("./datas/3_1_data/leftpants/13.csv");leftPantsRaw = sampleByData(leftPantsRaw);  leftPantsRaw = leftPantsRaw[110:910,]
rightPantsRaw = read.csv("./datas/3_1_data/rightpants/13.csv");rightPantsRaw = sampleByData(rightPantsRaw);  rightPantsRaw = rightPantsRaw[110:910,]
glassRaw = read.csv("./datas/3_1_data/glass/13.csv");glassRaw = sampleByData(glassRaw);  glassRaw = glassRaw[99:899,]
