SourceData=importdata('Top_3.csv');
startIndex = 97;
endIndex = 797;
...
title('Walking Accelerometer (Top-Local)','FontSize',14);
...
title('Walking Gyroscope (Top-Local)','FontSize',14);
...
title('Walking Magnetic (Top-Local)','FontSize',14);
