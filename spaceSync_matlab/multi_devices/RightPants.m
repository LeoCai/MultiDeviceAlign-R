SourceData=importdata('RightPants_3.csv');
startIndex = 82;
endIndex = 782;
...
title('Walking Accelerometer (RightPants-Local)','FontSize',14);
...
title('Walking Gyroscope (RightPants-Local)','FontSize',14);
...
title('Walking Magnetic (RightPants-Local)','FontSize',14);
