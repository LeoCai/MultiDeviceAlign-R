SourceData=importdata('LeftHand_3.csv');
startIndex = 111;
endIndex = 811;
...
title('Walking Accelerometer (LeftHand-Local)','FontSize',14);
...
title('Walking Gyroscope (LeftHand-Local)','FontSize',14);
...
title('Walking Magnetic (LeftHand-Local)','FontSize',14);
