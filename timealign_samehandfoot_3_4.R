...
top_data = read.csv(paste("./datas/3_4_data_samehandfoot/top/1",i,".csv",sep = ""))
leftHand_data = read.csv(paste("./datas/3_4_data_samehandfoot/lefthand/1",i,".csv",sep = ""))
rightHand_data = read.csv(paste("./datas/3_4_data_samehandfoot/righthand/1",i,".csv",sep = ""))
leftPants_data = read.csv(paste("./datas/3_4_data_samehandfoot/leftpants/1",i,".csv",sep = ""))
rightPants_data = read.csv(paste("./datas/3_4_data_samehandfoot/rightpants/1",i,".csv",sep = ""))
glass_data = read.csv(paste("./datas/3_4_data_samehandfoot/glass/1",i,".csv",sep = ""))
