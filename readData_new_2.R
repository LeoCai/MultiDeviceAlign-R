topRaw = read.csv("./datas/3_1_data/top/12.csv");topRaw = sampleByData(topRaw); topRaw = topRaw[100:900,]
leftHandRaw = read.csv("./datas/3_1_data/lefthand/12.csv");leftHandRaw = sampleByData(leftHandRaw);  leftHandRaw = leftHandRaw[110:910,]
rightHandRaw = read.csv("./datas/3_1_data/righthand/12.csv");rightHandRaw = sampleByData(rightHandRaw);  rightHandRaw = rightHandRaw[95:895,]
leftPantsRaw = read.csv("./datas/3_1_data/leftpants/12.csv");leftPantsRaw = sampleByData(leftPantsRaw);  leftPantsRaw = leftPantsRaw[91:891,]
rightPantsRaw = read.csv("./datas/3_1_data/rightpants/12.csv");rightPantsRaw = sampleByData(rightPantsRaw);  rightPantsRaw = rightPantsRaw[96:896,]
glassRaw = read.csv("./datas/3_1_data/glass/12.csv");glassRaw = sampleByData(glassRaw);  glassRaw = glassRaw[98:898,]
