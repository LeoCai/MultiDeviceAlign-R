...
top_data = read.csv(paste("./datas/3_5_data_gyro/top/1",i,".csv",sep = ""))
leftHand_data = read.csv(paste("./datas/3_5_data_gyro/lefthand/1",i,".csv",sep = ""))
rightHand_data = read.csv(paste("./datas/3_5_data_gyro/righthand/1",i,".csv",sep = ""))
leftPants_data = read.csv(paste("./datas/3_5_data_gyro/leftpants/1",i,".csv",sep = ""))
rightPants_data = read.csv(paste("./datas/3_5_data_gyro/rightpants/1",i,".csv",sep = ""))
glass_data = read.csv(paste("./datas/3_5_data_gyro/glass/1",i,".csv",sep = ""))

st = 60
et = 3000

r = testAlign(top_data, top_data,st,et,"top")
top = top_data[r[1]:r[2],]

r = testAlign(top_data, leftHand_data,st,et,"lefthand")
leftHand = leftHand_data[r[1]:r[2],]

r = testAlign(top_data, rightHand_data,st,et,"righthand")
rightHand = rightHand_data[r[1]:r[2],]

r = testAlign(top_data, leftPants_data,st,et,"leftpants")
leftPants = leftPants_data[r[1]:r[2],]

r = testAlign(top_data, rightPants_data,st,et,"rightpants")
rightPants = rightPants_data[r[1]:r[2],]

r = testAlign(top_data, glass_data,st,et,"glass")
